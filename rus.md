...
как доказал, что судна могут пересекать экватор не будучи разбитыми морскими
...
*   Они не экранируют автоматически спецсимволы за вас. Чтобы избегать
    уязвимостей [межсайтового скриптинга][4], вам всё ещё нужно обращаться с
    ненадёжными данными с осторожностью, точно так же, как если бы вы склеивали
    обычные строки.
...
на JS и разработчикам библиотек не только обойти эти ограничения, но ещё и много
чего. То, о чём я говорю, называется помеченными шаблонами.
